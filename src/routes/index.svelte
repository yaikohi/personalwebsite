...
<section>
	<div class="container mx-auto px-6 md:max-w-xl lg:max-w-2xl ">
		<div class="flex flex-col items-center space-x-8 md:px-0 lg:flex lg:flex-row lg:text-left">
			<div class="lg:pt-12">
				<h1
					class="text-3xl font-bold text-gray-900 transition-colors dark:text-white md:text-5xl md:capitalize"
				>
					hello
				</h1>
				<div class="pt-6 text-gray-800 dark:text-white">
					<p class="mb-4 ">
